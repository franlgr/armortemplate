<template>
  <div class="bg-white p-8 py-0 rounded-lg shadow-md max-w-md my-4 py-8 m-auto">
    ...
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center space-x-2">
        ...
        />
        <div>
          <a class="text-gray-800 font-semibold cursor-pointer">
            argentina-noticias.armortemplate.site
          </a>
    ...
    <div class="mb-4">
      <p class="text-gray-800">
        Introducing Armor Template, a robust and feature-rich web theme that
        combines the power of modern technologies to kickstart your next online
        project. Crafted with Vue3, Vuex, Tailwind CSS, Express.js (SSR),
        Node.js, and Socket.io, Feathers.js (rest) this versatile template
        offers everything you need to create a dynamic web presence. 🐱
        <a href="" class="text-blue-600">#CuteKitten</a>
