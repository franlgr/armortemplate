        ...
        <div class="md:grid-cols-4 grid-cols-1 gap-6 pt-4 pb-16 items-start container flex justify-between mx-auto mt-8">
            ...
            <div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <a href="#" class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Learn
                                    more</a>
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Get
            ...
            <div class="col-span-3">
                    ...
                    <div class="  rounded overflow-hidden group" v-for="product in products" :key="products.index">
                        ...
                        <div class="relative bg-gray-300">
                            ...
                            <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center 
                                ...
                                <router-link :to="{ name: 'site-product', params: { id: product._id } }" class="text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition" title="view product">
                ...
                <div class="join grid grid-cols-2 pagination w-64 m-auto py-8">
                    ...
                    <button class="join-item btn btn-outline" @click="nextPage" :disabled="products.length < perPage">Next</button>
                </div>
            </div>
