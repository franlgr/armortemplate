<template>
  <div>
    ...
    >
      <div
        class="w-full bg-blue-900 pt-16 pb-24 text-center background-container"
      >
        <h4 class="text-2xl text-gray-100">Choose the right plan for you</h4>
        <p class="text-sm text-gray-100 mt-2">
          Pricing built for businesses of all sizes. Choose package that suits
          your needs.
        </p>
        <div class="flex items-center justify-center mt-8">
          <button
            ...
            :class="billingType === 'month' ? 'bg-blue-300' : 'bg-gray-200'"
          ...
          <button
            @click="
              (billingType = 'year'),
                ...
                (proPrice = '421')
            "
            class="text-gray-800 px-4 py-2 rounded-tr-lg rounded-br-lg bg-gray-200 ml-4"
      ...
      <div
        class="w-full 2xl:w-3/4 flex items-center justify-center px-8 md:px-32 lg:px-16 2xl:px-0 mx-auto -mt-8"
      >
          ...
          <div class="bg-white shadow-2xl rounded-lg py-4">
            ...
            <ul class="border-t border-gray-300 py-8 space-y-6">
              <li class="flex items-center space-x-2 px-8">
                <span class="bg-green-600 rounded-full p-1">
                  <svg
              ...
              <li class="flex items-center space-x-2 px-8">
                ...
                <span class="text-gray-400 capitalize"
                  >access to collaborate github</span
                >
              </li>
              <li class="flex items-center space-x-2 px-8">
                <span class="bg-gray-300 rounded-full p-1">
            ...
            <div class="flex items-center justify-center mt-6">
              <a
                href="#"
                class="bg-green-600 hover:bg-blue-700 px-8 py-2 text-sm text-gray-200 uppercase rounded font-bold transition duration-150"
                title="Purchase"
                >Purchase</a
              >
            </div>
