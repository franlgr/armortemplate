        ...
        <div>
            ...
            <div class=" m-4 2xl:container ">
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 pb-24 ">
                    <div class="md:col-span-2 lg:col-span-1 my-12">
                    ...
                    <div>
                        <div class="h-full py-6 px-6 my-12 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <div class="lg:h-full py-8 px-6 my-12 text-gray-600 rounded-xl border border-gray-200 bg-white">
