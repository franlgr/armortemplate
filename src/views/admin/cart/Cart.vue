  ...
  <div>
    <div class="bg-gray-100 pt-20">
      ...
      <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="w-full md:max-w-2xl lg:max-w-3xl xl:max-w-4xl overflow-y-auto">
          <div v-for="item in cartItems" :key="item.product._id" class="mb-6">
            <div class="flex flex-col md:flex-row items-start rounded-lg bg-white p-6 shadow-md">
              <img :src="item.product.images[0]" alt="product-image" class="w-24 h-24 object-cover rounded-lg mb-4 md:mb-0 md:mr-4" />
              <div class="flex-1">
                <div class="md:flex md:justify-between md:items-center">
                  ...
                  <div class="mt-4 md:flex md:items-center md:space-x-4">
                    <div class="flex items-center border-gray-100">
                      <input
                        class="h-8 w-16 md:w-8 border bg-white text-center text-xs outline-none"
                        type="number"
        ...
        <div class="mt-6 md:mt-0 md:w-1/3">
          <div class="h-full rounded-lg border bg-white p-6 shadow-md">
            ...
            <router-link
              ...
              class="w-full p-4 mt-4 cursor-pointer hover:bg-[#2c7b60] bg-gray-300 rounded hover:text-white text-black flex items-center"
            >
              <p class="flex-1">Shipping</p>
              <i class="fa-solid fa-truck justify-self-end"></i>
            </router-link>
          </div>
        </div>
      </div>
