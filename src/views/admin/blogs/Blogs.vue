                ...
                <tr v-for="blog in blogs" :key="blog.index">
                  ...
                  <td>
                    <div class="flex items-center space-x-3">
                      <div class="avatar">
                        <div class="avatar">
                          <div class="mask mask-squircle w-12 h-12" v-for="(image, index) in blog.images" :key="index">
                  ...
                  <td>
                    <button class="flex flex-row items-center bg-white rounded-xl p-2 text-gray-500">
                      <div class="flex items-center justify-center h-8 w-8 bg-purple-300 rounded-full">
                        ...
                        <img v-else src="https://picsum.photos/200/300" alt="User Image" class="h-8 w-8 rounded-full" />
                      </div>
