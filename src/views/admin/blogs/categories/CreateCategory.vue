...
<template>
    <div>
      <div>
        <AdminHeader title="Create Category Blogs" class="mb-8"     icon="fa-solid fa-blog fa-beat"></AdminHeader>
        ...
        <div class="m-4 2xl:container my-4">
          <div class="">
            <FormKit type="form" id="comprar-example" submit-label="Guardar" @submit="submitHandler" :actions="true"
              #default="{ value }" v-model="formData">
              <FormKit v-model="category.title" class="mt-4" type="text" name="name" label="Title Category"
                placeholder="Category Title" help="What is your title Category ?" validation="required" />
              ...
              <FormKit v-model="category.slug" class="mt-4" type="text" name="name" label="Slug Category"
                placeholder="Slug Category" help="Slug Category ?" validation="required" />
