        ...
        <div class="">
          <div class="overflow-x-auto">
            <table class="table">
              ...
              <thead>
                <div>
                  <router-link v-if="isMobile"  :to="{ name: 'admin-events-categories-create'}">
                ...
                <tr v-for="category in categories" :key="category.index">
                  ...
                  <th>
                    <div v-if="!isMobile" class="flex justify-between">
                      <router-link :to="'/events?tag='+ category._id" class="flex items-center">
                        <button class="border w-8 h-8 border-blue-500 hover:border-blue-700 rounded-full p-2">
                          <i class="fas fa-eye text-blue-500"></i>
                        </button>
                      </router-link>
                      <router-link :to="{ name: 'admin-events-categories-edit', params: { id: category._id } }" class="flex items-center">
  ...
  window.removeEventListener('resize', this.updateWindowWidth);
    ...
    this.windowWidth = window.innerWidth;
      ...
      deleteCategories(ids, toastId) {
        ...
        Promise.all(ids.map((id) => FeathersClient.service('events-categories').remove(id)))
          .then((res) => {
