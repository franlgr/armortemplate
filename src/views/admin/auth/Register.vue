                ...
                <div class='hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
                    ...
                    <div class='space-y-5'>
                        ...
                        <router-link to="/login"
                            class="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Authenticate</router-link>
                    </div>
                ...
                <div class="flex flex-1 flex-col items-center justify-center relative w-full">
                    ...
                    <div class="flex flex-1 flex-col justify-center space-y-5 max-w-md w-full mt-8">
                        ...
                        <div class="flex flex-col max-w-md space-y-5">
                            ...
                            <FormKit type="form" prefix-icon="email" id="registration-example"
                                :form-class="submitted ? 'hide' : 'show'" submit-label="Login" @submit="submitHandler"
                                :actions="false" #default="{ value }" v-model="formData">
                                <h1>Register!</h1>
                                <p class="my-4">
                                ...
                                <hr />
                                <FormKit class="register" type="text" name="name" label="Your name" placeholder="Jane Doe"
                                    help="What do people call you?" validation="required" />
                                <FormKit class="register" type="text" name="email" label="Your email"
                                    placeholder="jane@example.com" help="What email should we use?"
                                ...
                                <div class="double">
                                    ...
                                    <FormKit class="register" type="password" name="password_confirm"
