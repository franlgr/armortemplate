  ...
  <div class="bg-white">
    ...
    <div class="flex min-h-screen">
      ...
      <div class="flex flex-row w-full">
        <!-- Sidebar -->
        <div
          class="hidden lg:flex flex-col justify-between bg-[#1ddd7e] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg background-login"
        >
    ...
    <PriceBtc />
          ...
          <div class="space-y-5">
            ...
            <router-link
              :to="{ name: 'register' }"
              class="inline-block flex-none text-lg px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white"
        ...
        >
          ...
          <!-- Login box -->
          <div
            class="flex flex-1 flex-col justify-center space-y-5 max-w-md"
            id="auth"
          >
            <div class="flex flex-col max-w-md space-y-5">
              ...
              <FormKit
                ...
                submit-label="Login"
                @submit="submitHandler(email, password)"
                :actions="false"
                #default="{ value }"
                v-model="formData"
              >
...
<style>
  ...
  #auth .formkit-outer button {
    background: #3a5d51 !important;
  ...
  #auth .formkit-outer button:hover {
    background: #17b666 !important;
  }
