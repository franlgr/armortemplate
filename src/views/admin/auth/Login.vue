          ...
          <div class="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
            ...
            <div class="flex flex-col max-w-md space-y-5">
              ...
              <button @click="login({ email, password })"
                class="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Authenticate</button>
