  ...
  <div class="p-2 py-4">
    ...
    <div class="flex items-center mt-8">
      <div class="space-y-2 w-full">
        <!-- quitar filtro -->
        <router-link class="flex items-center" :to="{ name: 'site-products' }">
        ...
        <router-link
          ...
          :key="category.index"
          :to="{ name: 'site-products', query: { tag: category._id } }"
        >
          <div class="text-gray-600 cursor-pointer">
            <input
              type="checkbox"
...
*/
  ...
  import CountProductsInCategory from '@/components/site/market/CountProductsInCategory.vue';
  export default {
    data() {
      return {
        data: [],
