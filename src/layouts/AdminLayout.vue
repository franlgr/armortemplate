<template>
    <div>
        <div>
                    <aside :class="[!getMenuState ? 'ml-[-100%]' : '']" class="fixed top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] menu">
                        <div class="contenido">
                            <button class="text-white lg:hidden m-4" @click="toggleMenu()">Close</button>
                            <div class="-mx-6 px-6 py-4">
                                <a href="#" title="home">
                                <img  src="https://tailus.io/sources/blocks/stats-cards/preview/images/logo.svg" class="w-32 mx-8 mt-2 m-auto" alt="tailus logo">
                            </a>
                            </div>
                            ...
                            <ul class="space-y-2 mt-8 tracking-wide bg-white p-4">
                                <li>
                                    <router-link @click="hiddenMenu()" to="/admin/dashboard" href="#" aria-label="dashboard" v-bind:class="{ 'from-sky-600 to-cyan-400': $route.path === '/admin/dashboard' || $route.path === '/admin' }" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-black bg-gradient-to-r bg-white">
