                ...
                <div class="container mx-auto px-6 py-3">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center justify-end w-full right-8 button-cart opacity-75 hover:opacity-100 sm:hidden">
                            ...
                            <button @click="cartMenuToggle()" v-if="
                    ...
                    >
                      ...
                      ></path>
                            ...
                            <div>
                                <button @click="isOpen = !isOpen" type="button" class="text-white hover:text-gray-500 focus:outline-none focus:text-gray-500" aria-label="toggle menu">
                    ...
                    <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                        <div class="flex flex-col sm:flex-row text-white">
                            <router-link to="/" class="my-1 hover:text-blue-500 p-2 text-center m-auto md:my-0 text-white"><i class="fa-solid fa-house px-4"></i
                  ...
                  >
                    <i class="fa-solid fa-blog px-4"></i><span class="">Blogs</span>
                            ...
                            <router-link to="/products" class="my-1 text-white hover:text-blue-500 p-2 text-center m-auto md:my-0">
                  ...
                  >
                    <i class="fa-solid fa-user px-4"></i><span class="">Users</span>
                            ...
                            <router-link to="/support" class="my-1 text-white hover:text-blue-500 p-2 text-center m-auto md:my-0">
